							...
							<div class="panel-body">
								<form method="post" action="/TransactionReport/ReportingServlet">
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="form-group">
												<label for="fromCreationDate"> Select From Date: </label>
												<div class="input-group date" id="fromDate"
													data-provider="datepicker">
													<input type="text" class="form-control"
														id="fromCreationDate" /> <span class="input-group-addon">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="form-group">
												<label for="toCreationDate"> Select To Date: </label>
												<div class="input-group date" id="toDate"
													data-provider="datepicker">
													<input type="text" class="form-control"
														data-provider="datepicker" id="toCreationDate" /> <span
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="form-group">
												<label for="Locations_List">Locations:</label> <select
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="form-group">
												<label for="Location_Types_List">Lane Types:</label> <select
													name="Lane_Type" class="form-control" id="Lane_Type">
													<option value="">--SELECT--</option>
													<%
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="form-group">
												<label for="Lanes">Lanes:</label> <select name="Lane"
													class="form-control" id="Lane">
													<option value="">--SELECT--</option>
													<%
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
											...
											<input type="hidden" name="ExportOption" value="0" /> <input
												type="submit" class="btn btn-default pull-right"
												name="submit_btn" value="Run" />
										</div>
									</div>
								</form>
							</div>
							...
							<div class="panel-body" style="text-align: center; padding: 5%;">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"
										...
										<form method="post"
											action="/TransactionReport/ReportingServlet">
									...
									<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"
										...
										<form method="post"
											...
											<button type="submit" class="btn btn-default"
												id="ExportAsExcel">Export as Excel</button>
										</form>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"
										style="text-align: center;">
										<form method="post"
											...
											<button type="submit" class="btn btn-default"
												id="ExportAsExcel">Print Report</button>
										</form>
									</div>
								</div>
							</div>
